...
| Year | Title | Status |
|------|-------|--------|
| 2026 | Physics-informed neural networks for thermohydrodynamic analysis of journal bearings with cavitation modelling | Under review — *Tribology International* |
| 2026 | Automatic Curriculum Scheduling for Homotopy-Based Physics-Informed Neural Networks | Under review |
